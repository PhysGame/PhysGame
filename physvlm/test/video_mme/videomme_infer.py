...
from physvlm.test.video_mme.utils import VideoMME_dataset, infer_videomme_llava, \
    infer_videomme_stllm
from physvlm.test.video_mme.eval_result import eval_your_results
...
def load_model_and_dataset(rank, world_size, args):
    ...
    dataset = VideoMME_dataset('/code/Video-MME/videomme/test-00000-of-00001.parquet', 
