...
from physvlm.models.clip import GatherLayer, CLIPModelwithVideo, CLIPVideoConfig
from physvlm.models.siglip import SiglipModelwithVideo, SiglipVideoConfig, SiglipPoolingHead_PatchCLS
from physvlm.models.utils import weighted_adaptive_avg_pool3d_loop, weighted_adaptive_avg_pool3d_unfold, get_state_dict
...
class PllavaSelf3DMultiModalProjector(nn.Module):
    supported_highres = ['pad_crop_four', 'slide', ]
    def __init__(self, config: LlavaNextConfig):
        super().__init__()  
        self.frame_shape = config.frame_shape
...
class LLaVASiglip3DMultiModalProjector(nn.Module):
    ...
    def forward(self, image_features, clip_ids, clip_mask, num_frames, after=True, video=True, output_visual_attention=False):
        ...
        image_embeds = self.clip_visual_head(self.clip_visual_ln(image_features))
