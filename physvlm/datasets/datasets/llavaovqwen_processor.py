...
import numpy as np
from transformers.models.llava_onevision import LlavaOnevisionProcessor, LlavaOnevisionImageProcessor, LlavaOnevisionVideoProcessor
...
from transformers.utils import TensorType, is_vision_available, logging, direct_transformers_import
...
class LlavaOnevisionVidImageProcessor(LlavaOnevisionImageProcessor):
...
class LlavaOnevisionVidProcessor(LlavaOnevisionProcessor):
    ...
    image_processor_class = LlavaOnevisionVidImageProcessor
