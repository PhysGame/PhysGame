...
def parse_args():
    ...
    parser.add_argument("--cfg-path", default='config/physvlm_dpo_training.yaml', help="path to configuration file.")
    parser.add_argument("--gpu-id", type=int, default=7, help="specify the gpu to load the model.")
    parser.add_argument("--ckpt-path", default="./ckpt/checkpoint_dpo")
...
class PhysVLM(gr.themes.base.Base):
    def __init__(
        self,
        *,
...
gvlabtheme = PhysVLM(primary_hue=colors.blue,
        secondary_hue=colors.sky,
        neutral_hue=colors.gray,
        spacing_size=sizes.spacing_md,
        radius_size=sizes.radius_sm,
...
title = """<h1 align="center"><a href="https://github.com/PhysGame/PhysGame"><img src="https://s21.ax1x.com/2024/12/02/pAIwK54.png" border="0" style="margin: 0 auto; height: 150px;" /></a> </h1>"""
description ="""
        CLICK FOR SOURCE CODE!<br><p><a href='https://github.com/PhysGame/PhysGame'><img src='https://img.shields.io/badge/Github-Code-blue'></a></p><p>
        """


with gr.Blocks(title="PhysVLM Chatbot!",theme=gvlabtheme,css="#chatbot {overflow:auto; height:500px;} #InputVideo {overflow:visible; height:320px;} footer {visibility: none}") as demo:
    gr.Markdown(title)
    ...
    with gr.Row():
        ...
        with gr.Column(visible=True)  as input_raws:
            chat_state = gr.State()
            img_list = gr.State()
            chatbot = gr.Chatbot(elem_id="chatbot",label='PhysVLM')
            with gr.Row():
