...
from physvlm.train.stllm_trainer import STLLMTrainer

import physvlm.tasks as tasks
from physvlm.common.config import Config
from physvlm.common.logger import setup_logger
...
def train():
    ...
    if task_name=='interleave_sft':
        ...
        data_module['data_collator'] = InterleaveDataCollator(tokenizer)
